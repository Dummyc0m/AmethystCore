...
public class AUButtonData {
    ...
    public AUButtonData(Material material) {
        this(material, 1, (short) 0);
    }

    public AUButtonData(Material material, int amount, short damage) {
        this(material, amount, damage, false, false);
    }

    public AUButtonData(Material material, int amount, short damage, boolean droppable, boolean transferable) {
