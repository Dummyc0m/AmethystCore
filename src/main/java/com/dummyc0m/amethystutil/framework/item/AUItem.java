 ...
 */
public abstract class AUItem{

    private AUItemData data;
    private final String module;
    private final String identifier;

    public AUItem() {
        this(new AUItemData(), "Amethyst", "amethyst:default");
    }

    public AUItem(AUItemData data, String module, String identifier) {
        this.data = data;
        this.module = module;
    ...
    public AUItemData getData(){
        return this.data;
    }

    public void setData(AUItemData data){
        this.data = data;
    }
