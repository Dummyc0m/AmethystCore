package com.dummyc0m.amethystutil.database;
 ...
 */
public class AUDBConnectionManager {
    ...
    public AUDBConnectionManager(String type, String hostname, int port, String database, String username, String password){
        this.type = type;
