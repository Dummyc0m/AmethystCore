 ...
 */
public class AUApproximateRegion {
    ...
    public AUApproximateRegion(int x1, int y1, int z1, int x2, int y2, int z2){
    ...
    public AUApproximateRegion(Location loc1, Location loc2){
    ...
    public AUApproximateRegion(AUApproximateRegion region){
    ...
    public boolean equals(Object o) {
        ...
        AUApproximateRegion region3i = (AUApproximateRegion) o;
